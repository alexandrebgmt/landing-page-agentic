      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-4">
        ...
        >
          <div className="text-center">
            ...
            <p className="text-xs text-slate-400 mt-1">Informe a chave mestra para ver os leads</p>
          </div>
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 p-8 font-sans">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8 border-b border-slate-800 pb-4">
          <div>
            <h1 className="text-2xl font-bold text-cyan-400">Pipeline de Leads NexusData</h1>
            <p className="text-sm text-slate-400">CRM de acompanhamento e gestão de diagnósticos</p>
          </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12 text-slate-500">Nenhum lead registrado ainda.</div>
        ) : (
                    ...
                    <tr key={lead.id} className="hover:bg-slate-800/40 transition">
                      <td className="p-4">
                        ...
                        >
                          ...
                          <option value="Em Contato" className="bg-slate-900 text-cyan-300">
                            🔵 Em Contato
                          </option>
                          <option value="Fechado" className="bg-slate-900 text-emerald-300">
                            🟢 Fechado
                          </option>
                        </select>
                      </td>
